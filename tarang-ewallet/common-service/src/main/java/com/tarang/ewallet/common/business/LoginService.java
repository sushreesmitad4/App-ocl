 ...
 * @Time : 4:51:52 PM
 * @Version : 1.0
 * @Comments: Service interface to provide Ewallet Login Services 
...
public interface LoginService {
	...
	/**
	 * Service to login with email and mPin and userType and TypeOfRequest
	 * 
	 * @param email
	 * @param mPin
	 * @return AuthResponseData - token and user role
	 * @throws WalletException
	 */
	Authentication loginWithDevice(String email, String mPin, String userType, Long typeOfRequest) throws WalletException;
	
	/**
	 * Service to changeMpin with authenticationId, oldMpin, newMPin
	 * @param oldMpin, newMPin
	 * @param mPin
	 * @return Boolean 
	 * @throws WalletException
	 */
