...
var SlimPicker = new Class({
	...
	options: {
		...
		yearStart: (new Date().getFullYear() - 0),                     // Default starting year for dropdown options is 5 years ago
		yearRange: 100,                                                 // Show a 10 year span
		yearOrder: 'desc',                                              // Counting up in years
