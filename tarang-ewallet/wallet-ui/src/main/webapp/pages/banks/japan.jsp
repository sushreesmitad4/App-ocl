...
<%@page import="com.tarang.ewallet.masterdata.util.BankAccountTypes"%>
	...
	<tr class="formtr">
		<td class="formtd">
			<form:label path="bankName" cssClass="formlebel">
	...
	<tr>
		...
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_JPN_FUTSUU%>" /><spring:message code="futsuu.lbl" /></td>
	</tr>
	<tr>
		<td></td>
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_JPN_TOUZA%>" /><spring:message code="touza.lbl" /></td>
	</tr>
	<tr>
		<td></td>
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_JPN_CHOCHIKU%>" /><spring:message code="chochiku.lbl" /></td>
	</tr>
	<tr>
		<td></td>
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_JPN_SONOTA%>" /><spring:message code="sonota.lbl" /></td>
	</tr>
	<tr>
		<td></td>
	...
	<tr class="formtr">
		<td class="formtd">
			<form:label path="sortCode" cssClass="formlebel">
				<spring:message code="zengin.bank.and.branch.code.lbl" /><span class="mfield">&nbsp;*</span>
			</form:label>
		</td>
