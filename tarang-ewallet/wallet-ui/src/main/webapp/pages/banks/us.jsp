...
<%@page import="com.tarang.ewallet.masterdata.util.BankAccountTypes"%>
	...
	<tr>
		...
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_US_CHECKINGS%>" /><spring:message code="checking.lbl"/></td>
	</tr>
	<tr>
		<td></td>
		<td><form:radiobutton path="accountType" value="<%=BankAccountTypes.ACCOUNT_TYPE_US_SAVINGS%>" /><spring:message code="savings.lbl"/></td>
	</tr>
	<tr>
		<td></td>
	...
	<tr class="formtr">
		<td class="formtd">
			<form:label path="sortCode" cssClass="formlebel">
				<spring:message code="routing.number.lbl" /><span class="mfield">&nbsp;*</span>
			</form:label>
		</td>
