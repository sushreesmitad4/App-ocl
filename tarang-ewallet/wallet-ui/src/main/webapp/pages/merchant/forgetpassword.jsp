...
<div class="pageheading"><spring:message code="merchant.forgot.password.lbl"/></div>
<jsp:include page="/pages/pageerrors.jsp"></jsp:include>
<form:form name="forgotpasswordform" method="POST" commandName="forgotPasswordForm" autocomplete="off" action="forgotpassword">
			<table class="form" style="width: 50%">
				<jsp:include page="/pages/forgetpassword.jsp"></jsp:include>
				<tr>
					<td colspan=2 align="center">
						<div class="formbtns">
								<input type="button" class="styled-button" value='<spring:message code="submit.lbl"/>' onclick="forSubmit()" />
